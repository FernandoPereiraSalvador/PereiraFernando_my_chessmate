...
/**
 * The Position class represents the state of the chess board and holds information about the game including the board,
...
public class Position {
    ...
    /**
     * Constructs a new instance of the Position class with the given Position object.
     *
     * @param position the Position object to be used in constructing the new instance
     */
    ...
    /**
     * Constructs a new instance of the Position class with the given Position object and last move.
     *
     * @param position the Position object to be used in constructing the new instance
     * @param last_move the last Move made in the game
     */
    ...
    /**
     * Initializes the chessboard with pieces for both players.
     *
     * @param humanWhite A boolean representing whether the human player will play with the white pieces or not.
     */
    ...
    /**
     * Updates the state of the game board based on the given move, which represents a piece movement from a source location to a destination location.
     *
     * @param move The move object that represents the movement of the piece.
     */
